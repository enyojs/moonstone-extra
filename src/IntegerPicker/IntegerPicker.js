...
module.exports = kind(
	/** @lends module:moonstone/IntegerPicker~IntegerPicker.prototype */
	{
		...
		components: [{
				...
				ondown: 'downNext',
				onholdpulse: 'next',
				classes: 'moon-scroll-picker-overlay-container next',
				components: [
			...
			// we're forcing TouchScrollStrategy
			{
				...
				classes: 'moon-scroll-picker-overlay-container previous',
				components: [
		...
		/**
		 * Triggers appropriate events when enter/back/backspace keys are pressed in SinpleIntegerPicker
		 * 
		 * @private
		 */
