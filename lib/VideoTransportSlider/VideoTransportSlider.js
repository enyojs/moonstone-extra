...
module.exports = kind(
	...
	*/
	tickComponents: [
		{name: 'startWrapper', classes: 'moon-video-transport-slider-indicator-wrapper start', components: [
			{name: 'beginTickText', classes: 'moon-video-transport-slider-indicator-text left', content: '00:00'}
		]},
		{name: 'endWrapper', classes: 'moon-video-transport-slider-indicator-wrapper end', components: [
			{name: 'endTickText', classes: 'moon-video-transport-slider-indicator-text right', content: '00:00'}
		]}
	],
	...
	*/
	popupComponents: [
		{name: 'popup', kind: Popup, classes: 'moon-slider-popup above moon-video-transport-slider-status-indicator', components: [
