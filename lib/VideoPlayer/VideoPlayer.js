...
module.exports = kind(
	...
	*/
	create: function() {
		...
		this.inlineChanged();
		this.setPlaybackRateHash(this.playbackRateHash);
	...
	*/
	...
	/**
	* Set new object for playbackRateHash.
	*
	* @param {Object} newHash - playbackRateHash object
	* @public
	*/
	setPlaybackRateHash: function(newHash) {
		this.playbackRateHash = this.$.video.playbackRateHash = newHash;
	},
