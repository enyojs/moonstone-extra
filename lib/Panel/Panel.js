...
module.exports = kind(
	...
	*/
	panelTools : [
		...
		{name: 'panelBody', kind: FittableRows, fit: true, canGenerate: false,  classes: 'moon-panel-body'},
	...
	*/
	initComponents: function () {
		...
		if (this.container.index == this.parent.indexOfChild(this)) {
			this.$.panelBody.canGenerate = true;
