/**
* Contains the declaration for the {@link module:moonstone-extra/Panel~Panel} kind.
* @module moonstone-extra/Panel
*/
...
/**
* Fires when this [panel]{@link module:moonstone-extra/Panel~Panel} has completed its pre-arrangement transition.
* No additional data is passed with this event.
*
* @event module:moonstone-extra/Panel~Panel#onPreTransitionComplete
* @type {Object}
* @public
*/

/**
* Fires when this [panel]{@link module:moonstone-extra/Panel~Panel} has completed its post-arrangement transition.
* No additional data is passed with this event.
*
* @event module:moonstone-extra/Panel~Panel#onPostTransitionComplete
* @type {Object}
* @public
*/
...
module.exports = kind(
	/** @lends module:moonstone-extra/Panel~Panel.prototype */ {
	...
	*/
	addControl: function (ctl, before) {
		if (ctl.spotlight) this.$.spotlightDummy.spotlight = false;
		UiComponent.prototype.addControl.apply(this, arguments);
	},
	...
	*/
	removeControl: function (ctl) {		
		UiComponent.prototype.removeControl.apply(this, arguments);
	...
	*/
	...
	/**
	* Updates [titleAbove]{@link module:moonstone-extra/Panel~Panel#titleAbove} when
	* [autoNumber]{@link module:moonstone-extra/Panel~Panel#autoNumber} changes.
	* @private
	*/
	...
	*/
	...
	/**
	* Called directly by {@link module:moonstone-extra/Panels~Panels}.
	* @private
	*/
	...
	*/
	...
	/**
	* Called directly on the panel by {@link module:moonstone-extra/Panels~Panels} when the panel has completed a
	...
	*
	* @param {Object} info - Information from the [Panels]{@link module:moonstone-extra/Panels~Panels} component.
	...
	* @param {Number} info.index - The current index of this [panel]{@link module:moonstone-extra/Panel~Panel}.
