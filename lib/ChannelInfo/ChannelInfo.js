...
module.exports = kind(
	...
	*/
	components: [
		...
		{kind: MarqueeText, name: 'channelName', classes: 'moon-video-player-channel-info-text'},
		{kind: MarqueeText, name: 'channelDesc', classes: 'moon-video-player-channel-info-text'},
		{kind: MarqueeText, name: 'channelMoreDesc', classes: 'moon-video-player-channel-info-text'},
