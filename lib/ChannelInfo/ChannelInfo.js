/**
* Contains the declaration for the {@link module:moonstone-extra/ChannelInfo~ChannelInfo} and
* {@link module:moonstone-extra/ChannelInfoBadge~ChannelInfoBadge} kinds.
* @module moonstone-extra/ChannelInfo
*/
...
/**
* {@link module:moonstone-extra/ChannelInfoBadge~ChannelInfoBadge} is a simple kind used to display a badge
* containing channel information. It is the default kind for components added
* to {@link module:moonstone-extra/ChannelInfo~ChannelInfo}.
*
...
var ChannelInfoBadge = kind(
	/** @lends module:moonstone-extra/ChannelInfoBadge~ChannelInfoBadge.prototype */ {
...
/**
* {@link module:moonstone-extra/ChannelInfo~ChannelInfo} is a control that displays channel information.  It is
...
*/
module.exports = kind(
	/** @lends module:moonstone-extra/ChannelInfo~ChannelInfo.prototype */ {
	...
	*/
	published: {
		...
		*/
		...
		/**
		* Some descriptions of the channel.
		*
		* @type {String}
		* @default ''
		* @public
		*/
		...
		/**
		* More detailed descriptions of the channel.
		*
		* @type {String}
		* @default ''
		* @public
		*/
		...
		/**
		* When `true`, [channelNo]{@link module:moonstone-extra/ChannelInfo~ChannelInfo#channelNo} will have locale-safe
		* uppercasing applied.
		*
		* @type {Boolean}
		* @default true
		...
		*/
		...
		/**
		* @deprecated Replaced by [uppercaseChannelNo]{@link module:moonstone-extra/ChannelInfo~ChannelInfo#uppercaseChannelNo}.
		*
...
/**
* The {@link module:moonstone-extra/ChannelInfoBadge~ChannelInfoBadge} definition
*/
