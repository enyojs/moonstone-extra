...
var ChannelInfoBadge = kind(
	...
	* @private
	*/
	classes: 'moon-video-badge-text text-icon'
});
...
module.exports = kind(
	...
	*/
	components: [
		{kind: MarqueeText, name: 'channelNo', classes: 'moon-header-font number'},
		{kind: MarqueeText, name: 'channelName', classes: 'text'},
		{kind: MarqueeText, name: 'channelDesc', classes: 'text'},
		{kind: MarqueeText, name: 'channelMoreDesc', classes: 'text'},
		{kind: Control, name: 'client', classes: 'badges'}
	],
