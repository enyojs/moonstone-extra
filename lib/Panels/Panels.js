...
module.exports = kind(
	...
	*/
	shouldArrange: function () {
		return this.generated && this.layout.shouldArrange ? this.layout.shouldArrange(this.fromIndex, this.toIndex) : true;
	},
	...
	*/
	adjustFirstPanelBeforeTransition: function() {
		...
		if (this.pattern == 'activity') {
			if (((from > to && to === 0) || (from === undefined && to === undefined)) && this.index === 0) {
				this.addClass('first');
	...
	*/
	indexChanged: function (old) {
		...
		if (!this.hasNode()) this.finishTransition();
	},
