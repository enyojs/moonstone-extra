/**
* Contains the declaration for the {@link module:moonstone-extra/Slider~Slider} kind.
* @module moonstone-extra/Slider
*/
...
*
* @event module:moonstone-extra/Slider~Slider#onChange
* @type {Object}
...
*
* @event module:moonstone-extra/Slider~Slider#onChanging
* @type {Object}
* @property {Number} value - The value of the current position.
* @public
*/
...
* event.
*
* @event module:moonstone-extra/Slider~Slider#onAnimateFinish
* @type {Object}
* @public
*/

/**
* {@link module:moonstone-extra/Slider~Slider} is a [control]{@link module:enyo/Control~Control} that presents a range of selection
...
*/
module.exports = kind(
	/** @lends module:moonstone-extra/Slider~Slider.prototype */ {
	...
	*/
	published: {
		...
		* [bgProgress]{@link module:moonstone-extra/ProgressBar~ProgressBar#bgProgress} value.
		*
		* @type {Boolean}
		* @default false
		* @public
		...
		* the [bgProgress]{@link module:moonstone-extra/ProgressBar~ProgressBar#bgProgress} value.
		*
		* @type {Boolean}
		* @default false
		* @public
		...
		*/
		...
		/**
		* @deprecated Replaced by [uppercase]{@link module:moonstone-extra/Slider~Slider#uppercase}.
		*
	...
	*/
	...
	/**
	* Every subkind of moon.Slider could override popupComponents according to its design.
	* You can simply compose your own popupComponents and override this method.
	* Plz refer moon.VideoPlayer.
	*
	* @protected
	*/
	...
	*/
	...
	/**
	* Called only when [constrainToBgProgress]{@link module:moonstone-extra/Slider~Slider#constrainToBgProgress} is
	* `true`.
	*
	* @private
	*/
	...
	/**
	* Initializes [value]{@link module:moonstone-extra/Slider~Slider#value} at creation time.
	*
	* @private
	*/
	initValue: function() {
	...
	*/
	...
	/**
	* @fires module:moonstone-extra/Slider~Slider#onAnimateFinish
	* @private
	*/
	...
	*/
	...
	/**
	* @fires module:moonstone-extra/Slider~Slider#onChange
	* @private
	*/
	...
	/**
	* @fires module:moonstone-extra/Slider~Slider#onChanging
	* @private
	*/
